...
The easiest way to keep events current is with [Claude Code](https://docs.anthropic.com/en/docs/claude-code):
...
- [Chart.js 4.x](https://www.chartjs.org/) via CDN (only external dependency)
